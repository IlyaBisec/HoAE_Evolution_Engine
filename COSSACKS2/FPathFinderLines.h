//---------------------------------------------------------------------------
__forceinline int LayLine(FPoint* _ptFrom, FPoint* _ptTo)
{
   LinePath.Clear();
...
//---------------------------------------------------------------------------
__forceinline bool CheckLine(FPoint* _ptFrom, FPoint* _ptTo)
{
   int xn = _ptFrom->x, yn = _ptFrom->y, xk = _ptTo->x, yk = _ptTo->y;
   int dx, dy, s, sx, sy, kl, swap, incr1, incr2;
...
//---------------------------------------------------------------------------
__forceinline int MakeLine(FPoint* _ptFrom, FPoint* _ptTo, FPath* Path)
{
   int xn = _ptFrom->x, yn = _ptFrom->y, xk = _ptTo->x, yk = _ptTo->y;
...
//---------------------------------------------------------------------------
__forceinline int VectorsOptimize(void)
{
   int RemovedNumber = 0;
...
//---------------------------------------------------------------------------
__forceinline int VectorsOptimize1(void)
{
   int RemovedNumber = 0;
