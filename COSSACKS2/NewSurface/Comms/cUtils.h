...
const COLORREF cGray75 = 0x00404040;
const COLORREF cGray50 = 0x00808080;
const COLORREF cGray25 = 0x00C0C0C0;
const COLORREF cWhite = 0x00FFFFFF;
const COLORREF cRed = 0x000000FF;
const COLORREF cGreen = 0x0000FF00;
const COLORREF cBlue = 0x00FF0000;
const COLORREF cCyan = 0x00FFFF00;
const COLORREF cMagenta = 0x00FF00FF;
