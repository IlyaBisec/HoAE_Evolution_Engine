...
public:
	...
	SAVE(be_CNodeArray);
		...
		REG_MEMBER(_bool,_visible);
		REG_METHOD_EX(&be_CNodeArray::FN_HIDE,_HIDE);

		REG_MEMBER(_bool,_editor);
		REG_MEMBER(_bool,_viewer);
		REG_METHOD_EX(&be_CNodeArray::FN_SWITCH_MODE,_SWITCH_MODE);

		REG_AUTO(_arrayVList);
		REG_METHOD_EX(&be_CNodeArray::FN_UPDATE_VIEWER,_UPDATE_VIEWER);
		REG_METHOD_EX(&be_CNodeArray::FN_SELECT_ARRAY,_SELECT_ARRAY);
		REG_METHOD_EX(&be_CNodeArray::FN_GOTO_EDITOR,_GOTO_EDITOR);
		...
		REG_METHOD_EX(&be_CNodeArray::FN_APLAY_PARAM_MASK,_APLAY_PARAM_MASK);
		REG_METHOD_EX(&be_CNodeArray::FN_CONVERT_TO_LOCAL,_CONVERT_TO_LOCAL);
		REG_MEMBER(_bool,_nodeAdd);
		REG_MEMBER(_bool,_nodeDel);
		REG_MEMBER(_bool,_nodeMove);
		REG_MEMBER(_bool,_nodeFree);

		REG_METHOD_EX(&be_CNodeArray::FN_CLEAR_ARRAY,_CLEAR_ARRAY);
		REG_METHOD_EX(&be_CNodeArray::FN_REORDER_ARRAY,_REORDER_ARRAY);
...
public:
	...
	SAVE(be_CNodes);
		...
		REG_MEMBER(_bool,_visible);
		REG_METHOD_EX(&be_CNodes::FN_HIDE,_HIDE);

		REG_MEMBER(_bool,_ADV);
		REG_MEMBER(_bool,_showADV);

		REG_AUTO(_nodeList);
		REG_METHOD_EX(&be_CNodes::FN_UPDATE_LIST,_UPDATE_LIST);
		REG_MEMBER(_bool,_visibleNodeList);
		REG_METHOD_EX(&be_CNodes::FN_APLAY_VISIBLE_LIST,_APLAY_VISIBLE_LIST);
		...
		REG_METHOD_EX(&be_CNodes::FN_DELETE,_DELETE);
		...
		REG_AUTO(_nodeY);
		REG_AUTO(_node);
		REG_METHOD_EX(&be_CNodes::FN_SELECT_NODE,_SELECT_NODE);
		REG_METHOD_EX(&be_CNodes::FN_ON_SCREEN,_ON_SCREEN);
...
public:
	...
	SAVE(be_CGroups);
		...
		REG_MEMBER(_bool,_visible);
		REG_METHOD_EX(&be_CGroups::FN_HIDE,_HIDE);
		...
		REG_METHOD_EX(&be_CGroups::FN_ADD_NEW_GR,_ADD_NEW_GR);
		
		REG_METHOD_EX(&be_CGroups::FN_SELECT_GROUP_ID,_SELECT_GROUP_ID);
		REG_AUTO(_nameGroup);
		REG_METHOD_EX(&be_CGroups::FN_ADD_SELECTED_UN,_ADD_SELECTED_UN);
		REG_METHOD_EX(&be_CGroups::FN_REM_SELECTED_UN,_REM_SELECTED_UN);

		REG_AUTO(_groupList);
		REG_METHOD_EX(&be_CGroups::FN_UPDATE_LIST,_UPDATE_LIST);
		REG_MEMBER(_bool,_visibleGroupList);
		REG_METHOD_EX(&be_CGroups::FN_APLAY_VISIBLE_LIST,_APLAY_VISIBLE_LIST);

		REG_MEMBER(_bool,_selectOnMap);
		REG_METHOD_EX(&be_CGroups::FN_DEL_GR,_DEL_GR);
		REG_METHOD_EX(&be_CGroups::FN_CLEAR_GR,_CLEAR_GR);
		REG_METHOD_EX(&be_CGroups::FN_ON_SCREEN_GR_ID,_ON_SCREEN_GR_ID);
		REG_METHOD_EX(&be_CGroups::FN_ON_SCREEN_GR,_ON_SCREEN_GR);
...
public:
	...
	SAVE(be_CSubfunction);
		...
		REG_MEMBER(_bool,_visible);
		REG_METHOD_EX(&be_CSubfunction::FN_HIDE,_HIDE);
		
		REG_MEMBER(_bool,selectOnMap);

		REG_AUTO(subFN_Name);
		REG_METHOD_EX(&be_CSubfunction::FN_OPENFILE,_OPENFILE);
		REG_METHOD_EX(&be_CSubfunction::FN_ADD,_ADD);
		REG_MEMBER(_bool,enterNameDD);
		REG_METHOD_EX(&be_CSubfunction::FN_OK,_OK);
		REG_METHOD_EX(&be_CSubfunction::FN_CANCEL,_CANCEL);
		...
		REG_METHOD_EX(&be_CSubfunction::FN_CLEAR_GR	, _CLEAR_GR	  );
		REG_METHOD_EX(&be_CSubfunction::FN_ADD_SEL_GR	, _ADD_SEL_GR );
		REG_METHOD_EX(&be_CSubfunction::FN_REM_SEL_GR	, _REM_SEL_GR );
		...
		REG_METHOD_EX(&be_CSubfunction::confirmSelectedParameterData,_CONFIRM);
...
public:
	...
	SAVE(be_CLego);
		...
		REG_METHOD_EX(&be_CLego::FN_HIDE,_HIDE);

		REG_METHOD_EX(&be_CLego::FN_DEBUG,_DEBUG);
		REG_METHOD_EX(&be_CLego::FN_GROUP,_GROUP);
		REG_METHOD_EX(&be_CLego::FN_NODE,_NODE);
		REG_METHOD_EX(&be_CLego::FN_ARRAY,_ARRAY);
		REG_METHOD_EX(&be_CLego::FN_SUBFN,_SUBFN);
