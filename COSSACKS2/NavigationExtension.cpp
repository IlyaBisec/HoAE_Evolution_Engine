...
bool bLandscapePanning = false;
// ================================================================================
// NavigationExtension::OnMouseHandling
// ================================================================================	
bool NavigationExtension::OnMouseHandling(int mx, int my, bool &LeftPressed,
	bool &RightPressed, int MapCoordX, int MapCoordY, bool OverMiniMap)
{
	...
	{
		if(bLandscapePanning == true)
		{
			float dx = LastMx - mx, dy = LastMy - my;
			if(bRotation)
			{
				const float RSpeed = 1.75f, RSingular = 300., // r / RSpeed == 1
					RHole = 200.;
		...
		{
			bLandscapePanning = true;
			LastMx = mx, LastMy = my;
			_mouseX = mouseX, _mouseY = mouseY;
		}
		return true;
	}
	bLandscapePanning = false;
	return false;
}