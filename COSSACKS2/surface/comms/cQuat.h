...
inline const cQuat cQuat::Mul(const cQuat &q0, const cQuat &q1) {
	...
	r.y = q0.w * q1.y + q0.y * q1.w + q0.z * q1.x - q0.x * q1.z;
	r.z = q0.w * q1.z + q0.z * q1.w + q0.x * q1.y - q0.y * q1.x;
...
// cQuat::ToPtr : float * ()
inline float * cQuat::ToPtr() {
	return &x;
}

// cQuat::ToPtr : const float * () const
inline const float * cQuat::ToPtr() const {
	return &x;
}
