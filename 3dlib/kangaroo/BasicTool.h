...
public:
    ...
    static  bool Locked;
	static  void ShowProgress		(int Stage,int NStages,const char* Message=NULL);
    ...
    virtual bool NeedMtlPreview     (){return false;}
    virtual bool NeedPenShapePreview(){return false;}
};