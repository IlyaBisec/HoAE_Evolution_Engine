...
public:
	...
	void SplitToSubSegs(cSegBezier<Type> *pSubSeg0, cSegBezier<Type> *pSubSeg1, const float tSplitAt = 0.5f) const;
...
//-----------------------------------------------------------------------------
// cSegBezier<Type>::GetPoint
//-----------------------------------------------------------------------------
template<class Type>
inline const Type & cSegBezier<Type>::GetPoint(const int index) const {
	assert(index >= 0 && index < 4);
	return m_Points[index];
}

//-----------------------------------------------------------------------------
// cSegBezier<Type>::GetMutablePoint
//-----------------------------------------------------------------------------
template<class Type>
inline Type & cSegBezier<Type>::GetMutablePoint(const int index) {
	assert(index >= 0 && index < 4);
	return m_Points[index];
}
