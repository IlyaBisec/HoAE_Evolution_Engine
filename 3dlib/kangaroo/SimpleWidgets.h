...
public:
	...
	wpcallback(BaseT* Class,FnProcess5 Function,int Param1,int Param2,int Param3,int Param4,int Param5){
		Type=6;
		C=Class;
		m_fnProcess5=Function;
		_Param1=Param1;
		_Param2=Param2;
		_Param3=Param3;
		_Param4=Param4;
...
public:
    ...
    bool    skip_lclick();
    bool    skip_rclick(); 
	bool	_tmp_AssignPopup(int F,int Key,int Shift,int Ctrl,int Alt);
