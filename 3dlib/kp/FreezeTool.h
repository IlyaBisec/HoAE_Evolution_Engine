...
public:
    ...
    virtual void CreateInterface    (BaseWidget* Where){        
        ...
        PenInterface::AddToolSlider(0,3000,&HeightScale,0xFFFF0000,"","FR_H_DIFF_HINT");
        PenInterface::AddToolHeader("FR_CLR_DIFF");
        PenInterface::AddToolSlider(0,255,&ColorDiff,0xFF00FF00,"","FR_CLR_DIFF_HINT");
        ...
        BaseWidget* F3=PenInterface::AddToolButton(19,"TOGGLE_FREEZE_VIEW");
        F3->AddCallback(WM_LBUTTONUP,new wpcallback<FreezeTool>(this,opToggleFreezeView));
    };
};