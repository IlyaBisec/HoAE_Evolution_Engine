...
//	static float CircCircle(cVec2 &Center,const cVec2 &t0, const cVec2 &t1, const cVec2 &t2);
	...
	static const cVec2 Unit;
	static const cVec2 xAxis;
	static const cVec2 yAxis;
...
// cVec2::ToPtr : float * ()
inline float * cVec2::ToPtr() {
	return (float *)&x;
}

// cVec2::ToPtr : const float * () const
inline const float * cVec2::ToPtr() const {
